...
# Code based on the Machine Perception 2022 course at ETH Zürich
class Constants(object):
    class __Constants:
        def __init__(self):
            # Environment setup.
            self.ABS_PATH = ""#"/cluster/home/rgrave/CIL-2022/"
            self.DEVICE = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
            self.model_path_checkpoints = self.ABS_PATH+"train_results/"
